<?php
/*
Plugin Name: GR8R Credit & Coupon Management
Description: Enhanced credit and coupon management system for WordPress with WooCommerce, WooCommerce Bookings, and Dokan Pro integration
Version: 1.0.0
Author: Resego
...
// Define constants
define('GR8R_ENHANCED_VERSION', '1.0.0');
define('GR8R_ENHANCED_PATH', plugin_dir_path(__FILE__));
define('GR8R_ENHANCED_URL', plugin_dir_url(__FILE__));

// Load dependencies
require_once GR8R_ENHANCED_PATH . 'enhanced-includes/class-security.php';
require_once GR8R_ENHANCED_PATH . 'enhanced-includes/class-credits-manager.php';
require_once GR8R_ENHANCED_PATH . 'enhanced-includes/class-coupon-manager.php';
require_once GR8R_ENHANCED_PATH . 'enhanced-includes/class-shortcodes.php';
require_once GR8R_ENHANCED_PATH . 'enhanced-includes/class-admin.php';
...
function gr8r_enhanced_create_database_tables() {
    ...
    $table_name = $wpdb->prefix . 'gr8r_enhanced_wrapper_products';
    $sql .= "CREATE TABLE $table_name (
...
function gr8r_enhanced_session_link_meta_box($post) {
    ...
    // Get available sessions for current vendor
...
function gr8r_enhanced_save_product_meta($post_id) {
    ...
    // Update or create wrapper product record
    global $wpdb;
